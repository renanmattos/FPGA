...
ExecStep xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot tb_debounce_behav --prj T:/renan/Debounce/Debounce.sim/sim_1/behav/tb_debounce.prj   xil_defaultlib.tb_debounce
